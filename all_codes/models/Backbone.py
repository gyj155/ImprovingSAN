...
class Backbone(nn.Module):
    def __init__(self, params=None):
        print('Backbone initialize')
        super(Backbone, self).__init__()

        self.params = params
        self.use_label_mask = params['use_label_mask']

        self.encoder = getattr(models, params['encoder']['net'])(params=self.params) #Densenet
        self.decoder = getattr(models, params['decoder']['net'])(params=self.params) #SAN_decoder
    ...
    def forward(self, images, images_mask, labels, labels_mask, is_train=True):
        ...
        if is_train:
            ...
            #print('word_probs', word_probs.shape) torch.Size([8, 18, 115])
